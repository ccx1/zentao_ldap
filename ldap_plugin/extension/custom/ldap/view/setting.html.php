...
<div class='container mw-700px'>
    <div id='titlebar'>
        <div class='heading'>
            <strong><?php echo $lang->ldap->common;
            echo $lang->ldap->setting; ?></strong>
        </div>
    </div>
    <form class='form-condensed pdt-20' method='post' action='<?php echo inlink('save'); ?>'>
        <table class='table table-form'>
            ...
            <tr>
                ...
                <td class='w-p50'>
                    <?php echo html::input('ldapVersion', $config->ldap->version, "class='form-control'"); ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-right">
                    ...
                    <button type='button' onclick='javascript:onClickTest()'
                        class='btn '><?php echo $lang->ldap->test; ?></button>
                </td>
            </tr>
            <tr>
